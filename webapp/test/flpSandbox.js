		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GR Order for Fence and NCR",
									"targetURL": "#GROrderforFenceandNCR-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"GROrderforFenceandNCR-display": {
								"semanticObject": "GROrderforFenceandNCR",
								"action": "display",
								"description": "Goods Receipt Order to QC Sloc for Fence and NCR",
								"title": "GR Order for Fence and NCR",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmmo071107",
									"url": sap.ui.require.toUrl("zmmo071107")
								}
							}
						}
					}
